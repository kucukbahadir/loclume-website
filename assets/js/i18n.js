...
(function () {
  const DICTS = {
    en: {
      ...
      "hero.sub": "Fast stock counts and shelf moves with a barcode scanner or your phone, compared with Stockitup in real time. No laptop to carry, no desk to go back to.",
      "hero.cta1": "Request a demo",
      "hero.cta2": "See how it works",
      "hero.p1b": "3× faster",
      "hero.p1s": "than manual counting",
      "hero.p2b": "1 scan",
      ...
      "hw.sub": "Install Loclume on an Android scanner terminal or just grab your phone. Walk, scan, done. Comparison and corrections happen on the move, not afterwards at a desk.",
      "hw.1t": "Android scanner terminal",
      "hw.1p": "Install the app on your scanner with built-in reader: the fastest option for big counts and daily shelf moves.",
      "hw.2t": "Phone camera",
      ...
      "faq.a2": "Three options: your phone camera, an Android scanner terminal with the Loclume app, or an existing HID/Bluetooth/USB scanner that sends barcodes as keyboard input. Serial scanning works with all three.",
